...
# We only test DenseNet-121 in this script for demo purpose 我们只在densenet121上运行了
...
# Subtract mean pixel and multiple by scaling constant 通过缩放常量减去平均像素和倍数
...
if K.image_dim_ordering() == 'th':
  # Transpose image dimensions (Theano uses the channels as the 1st dimension)移调图像尺寸（Theano使用通道作为第一维）
  ...
  weights_path = 'imagenet_models/densenet161_weights_tf.h5'#将121改成了densenet161
